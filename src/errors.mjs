export const ERROR_CODES = new Set([
  ...
  'CHAT_DISABLED', 'CHAT_CONTEXT_LIMIT', 'CHAT_INVALID_RESPONSE', 'CHAT_MODEL_UNAVAILABLE',
  'GEMINI_DISABLED', 'GEMINI_UNAVAILABLE', 'GEMINI_TIMEOUT', 'GEMINI_AUTH_FAILED', 'GEMINI_REJECTED', 'GEMINI_RATE_LIMITED',
